...
当前最新可下载版本：**[v0.1.4-alpha（预发布版）](https://github.com/StevenLee147/MyHKU/releases/tag/v0.1.4-alpha)**。按设备选择下表中的安装包，无需下载源码。

| 设备 | 对应安装包 | 最新版本下载 | 安装提示 |
| --- | --- | --- | --- |
| Windows 64 位电脑（Intel / AMD x64） | `MyHKU.Setup.0.1.4-alpha.exe` | [下载安装版 EXE](https://github.com/StevenLee147/MyHKU/releases/download/v0.1.4-alpha/MyHKU.Setup.0.1.4-alpha.exe) | 推荐；运行安装向导。 |
| Windows 64 位电脑（免安装） | `MyHKU.0.1.4-alpha.exe` | [下载便携版 EXE](https://github.com/StevenLee147/MyHKU/releases/download/v0.1.4-alpha/MyHKU.0.1.4-alpha.exe) | 下载后直接运行。 |
| Mac Apple Silicon（M 系列芯片 / arm64） | `MyHKU-0.1.4-alpha-arm64.dmg` | [下载 DMG](https://github.com/StevenLee147/MyHKU/releases/download/v0.1.4-alpha/MyHKU-0.1.4-alpha-arm64.dmg) | 拖入 Applications；如遇系统拦截，见[各设备安装指南](#各设备安装指南)。 |
| Mac Apple Silicon（ZIP 备用包） | `MyHKU-0.1.4-alpha-arm64-mac.zip` | [下载 ZIP](https://github.com/StevenLee147/MyHKU/releases/download/v0.1.4-alpha/MyHKU-0.1.4-alpha-arm64-mac.zip) | 解压后移入 Applications；系统拦截处理见[安装指南](#各设备安装指南)。 |
| Android 8.0 及以上手机 / 平板 | `app-release.apk` | [下载 APK（已签名）](https://github.com/StevenLee147/MyHKU/releases/download/v0.1.4-alpha/app-release.apk) | 下载后打开 APK，按系统提示允许安装此来源的应用。 |
| Android 应用商店分发 / 开发者 | `app-release.aab` | [下载 AAB](https://github.com/StevenLee147/MyHKU/releases/download/v0.1.4-alpha/app-release.aab) | 用于商店分发或生成 APK，不能直接点击安装。 |
...
可下载 [SHA256SUMS.txt](https://github.com/StevenLee147/MyHKU/releases/download/v0.1.4-alpha/SHA256SUMS.txt) 校验文件完整性；`.blockmap`、`latest.yml` 和 `latest-mac.yml` 是更新元数据，无需手动安装。
