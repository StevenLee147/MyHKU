...
Open this `android/` directory in Android Studio with JDK 17 and Android SDK 35. The repository includes a Gradle 8.10.2 wrapper; `./gradlew :app:assembleDebug` (or `gradlew.bat :app:assembleDebug` on Windows) builds the debug APK.
